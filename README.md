...
This is an axiom-split system. The unified-consciousness view can be enabled as an explicit philosophical axiom, but the software and the cited neuroscience study do not convert that axiom into an empirically certified fact.
...
Open `dikwp_cosmos_core_6_4a_standalone_exhibit.html` directly in a browser.

Install the evidence core:

```bash
python -m pip install dikwp_cosmos_core-1.0.0-py3-none-any.whl
cosmos-core demo --out outputs/reference
cosmos-core verify outputs/reference
cosmos-core conformance
cosmos-core serve outputs/reference --port 8874
```

## Evidence boundary

This is an E2 author-side deterministic research implementation. It does not certify phenomenal consciousness, a unified cosmic first-person perspective, survival after death, or a final physical theory.
